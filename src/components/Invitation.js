...
import groom from '../images/rajeshm.jpeg';
import bride from '../images/somam.jpeg';
...
const Invitation = () => {
    ...
    backgroundRepeat: "no-repeat"}}  alt="groom" className="img-responsive" />
                                ...
                                <div className="desc-groom">
                                    <h3>Rajesh Mandal</h3>
                                    <h5>S/O Kanailal Mandal</h5>
                                    <h5>Usharani Mandal</h5>
                                </div>
                            </div>
                            ...
                            <div className="couple-half">
                                ...
                                <div className="desc-bride">
                                    <h3>Soma Mandal (Sathi)</h3>
                                    <h5>D/O Harekrishna Mandal</h5>
                                    <h5>Shibani Mandal</h5>
                                </div>
                            </div>
                        </div>
